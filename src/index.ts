...
import { OMO_JSON_DEFAULT_PATH, expandOmoPath, importOmoJson, readOmoJsonFile } from './core/omo-json.ts'
...
/** Validate an incoming omo.json path string (trimmed, length-capped). */
