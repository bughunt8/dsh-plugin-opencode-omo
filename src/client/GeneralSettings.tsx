...
const STYLE: Record<string, CSSProperties> = {
  ...
  hint: { color: 'var(--dsw-alias-label-secondary, #616161)', fontSize: 11, lineHeight: 1.5 },
  toggle: {
    display: 'inline-flex',
    alignItems: 'center',
    gap: 8,
  ...
  success: { color: 'var(--dsw-alias-success, #2e7d32)', fontSize: 12 },
  error: { color: 'var(--dsw-alias-error, #c62828)', fontSize: 12, lineHeight: 1.5 },
}
